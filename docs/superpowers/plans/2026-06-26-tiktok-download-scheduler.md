...
- [ ] **Step 1: 写失败测试 `src/parser.test.ts`**
...
- [ ] **Step 1: 写失败测试 `src/uploader.test.ts`**
...
- [ ] **Step 1: 写失败测试 `src/worker.test.ts`**
...
- [ ] **Step 1: 写失败测试 `src/cli.test.ts`(只测 parseArgs)**
